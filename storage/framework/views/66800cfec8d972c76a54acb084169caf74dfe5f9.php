<?php $__env->startSection('title', ' поиск в KinoKor'); ?>
    ...
    <div class="category__container">
        <div class="main__container">
            <h1 class="category-title">
                ...
                <?php endif; ?>
                ", найдена: <?php echo e($products->count()); ?>
    ...
    <div class="main__container">
        <div class="category__content mt-15">
            ...
            <div class="content__product">
                ...
                <a href="<?php echo e(route('animeShow', $product->id)); ?>" class="content__product-name"><?php echo e($product->title); ?></a>
                ...
                <div class="content__product-navs">
                    <button class="btn-primary">Возрасть: +<?php echo e($product->old); ?></button>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saginbek/Рабочий стол/Git HUB/anifox/resources/views/home/anime/search.blade.php ENDPATH**/ ?>